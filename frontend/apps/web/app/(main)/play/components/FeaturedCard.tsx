  ...
  return (
    ...
    >
      <div className="absolute bottom-2 right-4 flex items-end gap-0.5 opacity-90">
        <QueenIcon className="h-24 w-auto [filter:drop-shadow(1px_0_0_rgba(241,232,217,0.4))_drop-shadow(-1px_0_0_rgba(241,232,217,0.4))_drop-shadow(0_1px_0_rgba(241,232,217,0.4))_drop-shadow(0_-1px_0_rgba(241,232,217,0.4))]" />
        <div className="relative">
          ...
          <KingIcon className="h-[110px] w-auto origin-bottom rotate-[11deg]" />
        </div>
      </div>
